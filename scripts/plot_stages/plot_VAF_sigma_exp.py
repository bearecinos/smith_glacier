...
ax2.plot(sigma_conv_gold['ind2'],
         ...
         # label='slope =' + str(round(sigma_conv_gold['slope'], 5)) +
...
ax2.plot(sigma_conv_c4['ind2'],
         ...
         # label='slope =' + str(round(sigma_conv_c4['slope'], 5)) +
...
ax2.plot(sigma_conv_c3['ind2'],
         ...
         label='slope =' + str(round(sigma_conv_c3['slope'], 5)) +
...
ax3.plot(sigma_conv_c8['ind2'],
         ...
         label='slope =' + str(round(sigma_conv_c8['slope'], 5)) +
...
ax3.plot(sigma_conv_c7['ind2'],
         ...
         label='slope =' + str(round(sigma_conv_c7['slope'], 5)) +
...
ax3.plot(sigma_conv_c6['ind2'],
         ...
         label='slope =' + str(round(sigma_conv_c6['slope'], 5)) +
