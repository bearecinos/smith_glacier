...
ax2.plot(sigma_conv_c2['ind2'],
         ...
         label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c2['sigma_full'])) +
...
ax2.plot(sigma_conv_gold['ind2'],
         ...
         # label=r'$\sigma^{2}_{full}$ =' + "{:.2e}".format(str(round(sigma_conv_gold['sigma_full'], 5))) +
...
ax2.plot(sigma_conv_c4['ind2'],
         ...
         # label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c4['sigma_full'])) +
...
ax2.plot(sigma_conv_c1['ind2'],
         ...
         # label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c1['sigma_full'])) +
...
ax2.plot(sigma_conv_c3['ind2'],
         ...
         label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c3['sigma_full'])) +
...
ax3.plot(sigma_conv_c8['ind2'],
         ...
         label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c8['sigma_full'])) +
...
ax3.plot(sigma_conv_c7['ind2'],
         ...
         label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c7['sigma_full'])) +
...
ax3.plot(sigma_conv_c6['ind2'],
         ...
         label=r'$\sigma^{2}_{full}$ =' + "{:.1E}".format(Decimal(sigma_conv_c6['sigma_full'])) +
