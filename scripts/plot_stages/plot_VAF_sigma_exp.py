...
ax2.plot(sigma_conv_c2['ind2'],
         np.exp(sigma_conv_c2['sigma_full'] * sigma_conv_c2['ind2'] + sigma_conv_c2['inter']),
         linewidth=3, color=color_prior[0], alpha=0.5,
         label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c2['sigma_full'], 5)) +
...
ax2.plot(sigma_conv_gold['ind2'],
         np.exp(sigma_conv_gold['sigma_full'] * sigma_conv_gold['ind2'] + sigma_conv_gold['inter']),
         linewidth=3, color=color_prior[1], alpha=0.5)
         # label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_gold['sigma_full'], 5)) +
...
ax2.plot(sigma_conv_c4['ind2'],
         np.exp(sigma_conv_c4['sigma_full'] * sigma_conv_c4['ind2'] + sigma_conv_c4['inter']),
         linewidth=3, color=color_prior[2], alpha=0.5)
         # label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c4['sigma_full'], 5)) +
...
ax2.plot(sigma_conv_c1['ind2'],
         np.exp(sigma_conv_c1['sigma_full'] * sigma_conv_c1['ind2'] + sigma_conv_c1['inter']),
         color=color_prior[3], alpha=0.5, linewidth=3)
         # label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c1['sigma_full'], 5)) +
...
ax2.plot(sigma_conv_c3['ind2'],
         np.exp(sigma_conv_c3['sigma_full'] * sigma_conv_c3['ind2'] + sigma_conv_c3['inter']),
         linewidth=3, color=color_prior[4], alpha=0.5,
         label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c3['sigma_full'], 5)) +
...
ax3.plot(sigma_conv_c8['ind2'],
         np.exp(sigma_conv_c8['sigma_full'] * sigma_conv_c8['ind2'] + sigma_conv_c8['inter']),
         linewidth=3, color=vel_color[0], alpha=0.5,
         label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c8['sigma_full'], 5)) +
...
ax3.plot(sigma_conv_c7['ind2'],
         np.exp(sigma_conv_c7['sigma_full'] * sigma_conv_c7['ind2'] + sigma_conv_c7['inter']),
         linewidth=3, color=vel_color[1], alpha=0.5,
         label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c7['sigma_full'], 5)) +
...
ax3.plot(sigma_conv_c6['ind2'],
         np.exp(sigma_conv_c6['sigma_full'] * sigma_conv_c6['ind2'] + sigma_conv_c6['inter']),
         color=vel_color[2], alpha=0.5, linewidth=3,
         label=r'$\sigma^{est}_{full}$ =' + str(round(sigma_conv_c6['sigma_full'], 5)) +
